...
knitr::kable(data.frame(gridsearch_data))

```

Using this hyperparameter value, a Ridge model was fitted to the traing data and evaluated on the test data. The results can be seen in the table below.

```{r Table 3, echo = FALSE, fig.width = 5, fig.height = 4, out.width = "50%"}
test_data <- read.csv('../results/tables/test_scores.csv')
knitr::kable(data.frame(test_data))
...
```{r fig.cap = "Figure 3", echo = FALSE, fig.width = 5, fig.height = 4, out.width = "100%"}
